            ...
            <section className="my-10 space-y-8">
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    <h2 className="text-2xl font-semibold">
                        Privacy Policy for Bloodbags
                    </h2>
                    <p>
                        At Bloodbags, one of our main priorities is the privacy
                        of our visitors. This Privacy Policy document contains
                        types of information that is collected and recorded by
                        Bloodbags and how we use it.
                    </p>
                    <p>
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    ...
                    <p>
                        Bloodbags follows a standard procedure of using log
                        ...
                        website, and gathering demographic information. Our
                        Privacy Policy was created with the help of the Privacy
                        Policy Generator.
                    </p>
                </div>
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    ...
                    <p>
                        Like any other website, Bloodbags uses "cookies". These
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    ...
                    <p>
                        ...
                        each of the advertising partners of Bloodbags.
                        ...
                        on Bloodbags, which are sent directly to users' browser.
                        ...
                        websites that you visit. Note that Bloodbags has no
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    ...
                    <p>
                        Bloodbags's Privacy Policy does not apply to other
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    ...
                    <p>
                        Bloodbags does not knowingly collect any Personal
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    ...
                    <p>
                        ...
                        collect in Bloodbags. This policy is not applicable to
