    ...
    return (
        <GuestLayout>
            <section className="lg:container mx-auto my-10 space-y-8">
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    <h2 className="text-2xl font-semibold">
                        Terms and Conditions
                    </h2>
                    <p>Welcome to Bloodbags!</p>
                    <p>
                        These terms and conditions outline the rules and
                        regulations for the use of Bloodbags's Website, located
                        at blank. By accessing this website we assume you accept
                        these terms and conditions. Do not continue to use
                        Bloodbags if you do not agree to take all of the terms
                    ...
                    <p>
                        ...
                        Our Terms and Conditions were created with the help of
                        the Terms & Conditions Generator.
                    </p>
                </div>
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    ...
                    <p>
                        We employ the use of cookies. By accessing Bloodbags,
                        you agreed to use cookies in agreement with the
                        Bloodbags's Privacy Policy. Most interactive websites
                        use cookies to let us retrieve the user's details for
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    ...
                    <p>
                        Unless otherwise stated, Bloodbags and/or its licensors
                        own the intellectual property rights for all material on
                        Bloodbags. All intellectual property rights are
                        reserved. You may access this from Bloodbags for your
                        own personal use subjected to restrictions set in these
                        terms and conditions. You must not:
                    </p>
                    <div>
                        <ul className="list-disc list-inside leading-loose indent-4">
                            <li>
                                Republish material from Bloodbags Sell, rent or
                            </li>
                            <li>
                                sub-license material from Bloodbags Reproduce,
                            </li>
                            <li>duplicate or copy material from Bloodbags</li>
                            <li>Redistribute content from Bloodbags</li>
                        </ul>
                    ...
                    <p>
                        Bloodbags reserves the right to monitor all Comments and
                    ...
                    <div>
                        ...
                        <p>
                            You hereby grant Bloodbags a non-exclusive license
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    ...
                    <div>
                        <p>
                            ...
                            compensates the absence of Bloodbags; and (d) the
                            link is in the context of general resource
                            information.
                        </p>
                        <p>
                            ...
                            or approval of the linking party and its products or
                    ...
                    <div>
                        <p>
                            ...
                            to Bloodbags. Please include your name, your
                    ...
                    <p>
                        No use of Bloodbags's logo or other artwork will be
                ...
                <div className="px-6 lg:px-8 space-y-4 text-justify">
                    ...
                    <div>
                        <p>
                            ...
                            and inform us any moment. We will consider requests
                            to remove links but we are not obligated to or so or
