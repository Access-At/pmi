...
Route::middleware('auth')->prefix('dashboard')->group(function () {
    ...
    Route::get('/schedule/create', [DashboardController::class, 'createSchedule'])->name('dashboard.pmi.create');
    Route::post('/schedule/create', [DashboardController::class, 'storeSchedule'])->name('dashboard.pmi.store');
    Route::get('/schedule/update/{slug}', [DashboardController::class, 'editSchedule'])->name('dashboard.pmi.edit');
    Route::post('/schedule/update/{slug}', [DashboardController::class, 'updateSchedule'])->name('dashboard.pmi.update');
    Route::delete('/schedule/{slug}', [DashboardController::class, 'deleteSchedule'])->name('dashboard.pmi.delete');
});
